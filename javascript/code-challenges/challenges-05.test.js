...
const toLastNames = people => {
  // Solution code here...
  let personName = people.map((person) => {
...
const addValues = (arr) => {
  // Solution code here...
  const newValues = arr.reduce((arr, value) => {
    return arr + value;
...
const addPurchases = (arr) => {
  // Solution code here...
  const totalAmount = arr.reduce((acc, value) => {
    return value.purchasePrice + acc;
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const totalNoElements = arr.reduce((acc) => {
    acc++;
    return acc;
  }, 0);
...
const returnNames = (arr) => {
  // Solution code here...
  const nameArr = arr.reduce((acc, value) => {
    acc.push(value.name);
    return acc;
...
const reversedString = (str) => {
  ...
  let stringarr = splitstr.reduce((arr, value) => {
    return value + arr;
  }, '');
  return stringarr;
