...
const containsAnd = (arr) => {
  // Solution code here...
  let andIncluded = arr.filter((word) => {
    return word.includes('and');
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  let notIncludedNums = arr.filter((value) => {
    return (value !== [forbiddenValues]);
  });
